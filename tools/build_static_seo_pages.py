...
STYLE_V = "20260923-shipping"  # css/style.css cache-bust; must match the live pages
...
("Does FLYLYFE ship worldwide?","FLYLYFE ships worldwide — to 200+ countries, every country except Russia and Belarus. US standard shipping is calculated by weight at checkout, from $11.49 for one tee; international shipping is calculated the same way, from $19.49 for one tee, and any import duties, VAT or customs fees charged on delivery are paid by the customer. Production takes 7–10 business days, followed by delivery."),
...
s=re.sub(r'(css/style\.css\?v=)[A-Za-z0-9-]+', r'\g<1>'+STYLE_V, s)
for asset in (r'css/product\.css', r'css/seo-pages\.css', r'js/app\.js'):
...
- Ships worldwide to 200+ countries (every country except Russia and Belarus); international shipping is calculated by weight at checkout, from $19.49 for one tee (UK, Ireland, EU, Argentina and most countries $19.49; Canada from $19.99). Import duties, VAT and customs fees charged by the destination country on delivery are paid by the customer. Delivery times vary by destination.
- US shipping: standard shipping only, calculated by weight at checkout — from $11.49 for one tee; two regular-weight tees are about $12.49.
...
Yes. FLYLYFE ships worldwide to 200+ countries (every country except Russia and Belarus). International shipping is calculated by weight at checkout, from $19.49 for one tee (Canada from $19.99), and any import duties, VAT or customs fees charged on delivery are paid by the customer. US standard shipping is calculated by weight at checkout, from $11.49 for one tee.
